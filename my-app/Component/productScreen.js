        ...
        <View style={styles.filterIcons}>
          <TouchableOpacity>
            <View style={styles.filterButton}>
              <Image source={require('../assets/Down.png')} style={styles.filterIcon} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity>
            <View style={styles.filterButton}>
              <Image source={require('../assets/Refresh.png')} style={styles.filterIcon} />
            </View>
          </TouchableOpacity>
        </View>
      </View>
          ...
          <View style={styles.productContainer}>
            <View style={styles.imageContainer}>
              ...
              <TouchableOpacity style={styles.addToCartButton} onPress={() => handleAddToCart(item)}>
                <Image source={require("../assets/Tag.png")} style={styles.addToCartIcon} />
              </TouchableOpacity>
            </View>
